		...
		try {
			...
			for (Usuario usuario : ManagerUsuarios.getUsuarios()){
				...
				if(nombreUsuario.contains(nombre)) {
                    ...
                    objetoJSON.put("numeroTelefono",usuario.getNumeroTelefono());
                    objetoJSON.put("fotoPerfil",usuario.getFotoPerfil());
                    objetoJSON.put("generosPreferidos",usuario.getGenerosPreferidos());
                    objetoJSON.put("librosEnVenta",usuario.getLibrosEnVenta());
                    objetoJSON.put("metodoAutenticacion",usuario.getMetodoAutenticacion());
